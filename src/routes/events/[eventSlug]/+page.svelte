<script lang="ts">
  ...
  import ApplicationChoices from '$lib/components/ApplicationChoices.svelte';
  let { data } = $props();
...
<div class="event-applications">
  <ApplicationChoices event={data.event} applications={data.applications} signedIn={!!data.user} />
</div>
